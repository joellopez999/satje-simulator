...
export default function EscritosPage() {
  ...
  const handleSubmitEscrito = async (e: React.FormEvent) => {
    ...
    try {
      // Aquí se conectaría con Supabase para guardar el escrito
      console.log('Guardando escrito:', {
        ...escritoData,
      ...
      setTimeout(() => {
        ...
        setShowCreateForm(false)
        setEscritoData({ tipo_petitorio: '', contenido: '', calidad: '', archivo: null })
      }, 2000)
    } catch (error) {
                  ...
                  <div className="bg-judicial-50 border border-judicial-200 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-judicial-600">
                          {new Date(selectedExpediente.fecha_creacion).toLocaleDateString('es-EC', {
                            year: 'numeric',
                            month: 'long',
                            day: 'numeric'
                          })}
