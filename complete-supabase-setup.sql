-- =============================================
-- Script para completar la configuración de Supabase
-- Sistema SSATJE - Simulador de Tribunales
-- =============================================

-- Verificar si la tabla users ya existe y su estructura
SELECT column_name, data_type, is_nullable 
FROM information_schema.columns 
WHERE table_name = 'users' AND table_schema = 'public';

-- Crear tabla de contraseñas de usuarios (si no existe)
...
-- Crear políticas de seguridad más específicas
CREATE POLICY "Enable all operations for authenticated users" ON users
  FOR ALL USING (true) WITH CHECK (true);

CREATE POLICY "Enable all operations for user_passwords" ON user_passwords
  FOR ALL USING (true) WITH CHECK (true);
