  ...
  return (
    <>
      ...
      <div
        id="sidebar"
        className={`
          fixed top-0 left-0 h-full w-64 bg-white border-r border-judicial-200 shadow-sm z-50 transform transition-transform duration-300 ease-in-out overflow-y-auto
